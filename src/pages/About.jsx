        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 max-md:!px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-md:!flex max-md:!flex-col max-md:!gap-0 max-md:!items-center">
            ...
            <div className="relative group max-md:!w-full max-md:!flex-shrink-0 max-md:!mb-[12px] max-md:!px-[12px] flex justify-center">
              <div className="relative z-10 rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl transition-transform duration-700 group-hover:scale-[1.02] max-md:!rounded-[12px] max-md:!h-[180px] max-w-[280px]">
                <img
                  src="/images/about/dawn-landscape-mountains-247478.jpg"
                  alt="About Us Hero"
                  className="w-full h-full object-cover aspect-[4/5] object-center max-md:!h-[180px]"
                />
              </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
            ...
            <div className="w-full lg:flex-1 space-y-8 md:space-y-10 px-6 md:px-0">
              <div className="space-y-2 max-lg:text-center lg:text-left">

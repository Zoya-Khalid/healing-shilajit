...
export default function ProductCard({ product }) {
  ...
  return (
    <div onClick={handleCardClick} className="group cursor-pointer bg-black p-6 rounded-[2.5rem] border-2 border-black shadow-sm hover:shadow-xl transition-all duration-500 max-md:!p-[10px] max-md:!rounded-[12px] md:p-5 max-md:flex max-md:flex-col max-md:justify-between h-full">
      {/* 1. Image Container - Full Wrap, No Padding */}
      <div className="relative mb-6 overflow-hidden aspect-square rounded-[1.5rem] max-md:!mb-[8px] max-md:!aspect-auto max-md:!h-[140px] max-md:!rounded-[10px] md:aspect-square md:rounded-[1.5rem]">
        {/* Product Images */}
      ...
      <div className="px-2 max-md:!px-0 flex flex-col flex-grow">
        ...
        <div className="flex flex-col mb-1 max-md:mb-0">
          <h3 
            className="font-bold text-lg text-white leading-[1.4] group-hover:text-gray-200 transition-colors max-md:!text-[12px] max-md:!leading-[1.4] max-md:min-h-[36px] max-md:mb-0 md:text-[16px] md:font-semibold md:mt-[12px] md:mb-[6px]"
            style={{ display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'visible' }}
          >
            {product.name}
          </h3>
          <div className="text-white font-bold text-lg max-md:!text-[13px] max-md:!font-[600] max-md:!my-[6px] md:text-[18px] md:font-bold md:mb-[6px]">
        ...
        <div className="flex gap-3 max-md:!gap-[6px] mt-auto">
          <button
            ...
            className="flex-1 w-full border border-white/40 bg-transparent text-white font-semibold py-2.5 rounded-full text-sm hover:bg-white/10 transition-colors max-md:!text-[11px] max-md:tracking-tighter max-md:!px-0 max-md:!py-0 max-md:!h-[34px] max-md:flex max-md:items-center max-md:justify-center md:h-[44px] md:text-[14px] md:px-[20px] md:rounded-full"
          >
            Add to Cart
          </button>
          <button
            onClick={handleBuyNow}
            className="flex-1 w-full bg-white text-black font-semibold py-2.5 rounded-full text-sm hover:bg-gray-200 transition-colors max-md:!text-[11px] max-md:tracking-tighter max-md:!px-0 max-md:!py-0 max-md:!h-[34px] max-md:flex max-md:items-center max-md:justify-center md:h-[44px] md:text-[14px] md:px-[20px] md:rounded-full"
          >
            Buy Now
          </button>
        </div>
